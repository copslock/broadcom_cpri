...
#ifndef OSPREY7_V2L8P1_API_DIAG_H
#define OSPREY7_V2L8P1_API_DIAG_H
...
/*! @file
 *  @brief Diagnostic functions provided to IP User
 */
...
/*! @defgroup SerdesAPIDiagTag Diagnostic APIs
 * Serdes API functions for displaying lane and core states,
 * performing eye and BER scans, and other diagnostics.
 */

/*! @addtogroup SerdesAPIDiagTag
 * @{
 */
...
struct osprey7_v2l8p1_eyescan_options_st {
...
/** Column definition header for osprey7_v2l8p1_display_core_state() API output.
 * To be called before osprey7_v2l8p1_display_core_state_line() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Call osprey7_v2l8p1_display_core_state_hdr() API before and osprey7_v2l8p1_display_core_state_legend() after
...
/** Detailed description of each column in osprey7_v2l8p1_display_core_state_line() API output.
 * To be called after osprey7_v2l8p1_display_core_state_line() API to display the legends.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @code
        ...
        osprey7_v2l8p1_log_api_event(sa__, event_id, data1, data2);
...
/** Displays Passive Eye Scan from -0.5 UI to 0.5UI to BER 1e-7 on all lanes in parallel.
 *  Function uses uC to acquire data.
 *  It also retrieves the data and displays it in ASCII-art style, where number N corresponds to 1e-N.
 *
 * This function retrieves the data from uC in horizontal stripe fashion.
...
#define EYE_SCAN_INTRUSIVE_WIDTH (EYE_SCAN_DISPLAY_SRIPE_SIZE>>1)
#define INTRUSIVE_BUF_SIZE (EYE_SCAN_INTRUSIVE_WIDTH*(EYE_SCAN_PAM_VERTICAL_IDX_MAX+1))
/** Displays Intrusive Eye Scan for 0.167 UI peak to peak to BER 1e-5.
 *  Function uses uC to acquire data.
 *  It also retrieves the data and displays it in ASCII-art style, where number N corresponds to 1e-N
 *
 * This function retrieves the data from uC in horizontal stripe fashion
...
/** Displays Intrusive Eye Scan for 0.167 UI peak to peak to BER 1e-5  on all lanes in parallel.
 *  Function uses uC to acquire data.
 *  It also retrieves the data and displays it in ASCII-art style, where number N corresponds to 1e-N
 *
 * This function retrieves the data from uC in horizontal stripe fashion
 ...
 * This function only initiates the processor actions. User must use osprey7_v2l8p1_read_eye_scan_stripe() function
 ...
 * osprey7_v2l8p1_start_ber_scan_test(), osprey7_v2l8p1_read_ber_scan_data(), osprey7_v2l8p1_display_ber_scan_data().
 *
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] rate specifies the data rate in Hz.
 * @param[in] ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum).
 ...
 * \n Note: Call functions osprey7_v2l8p1_display_lane_state_hdr(sa__) before and osprey7_v2l8p1_display_lane_state_legend() after
...
/** Column definition header for osprey7_v2l8p1 display state.
 * To be called before osprey7_v2l8p1_display_lane_state() function.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p1_display_lane_state_hdr(srds_access_t *sa__);

/** Detailed explanation of each column in osprey7_v2l8p1 display state.
 * To be called after osprey7_v2l8p1_display_lane_state() function to display the legends.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * This function is required to be implemented by upper level software to enable osprey7_v2l8p1 support.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which provides access to all osprey7_v2l8p1 control and status bits
 * This function is required to be implemented by upper level software to enable osprey7_v2l8p1 support.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] osprey7_v2l8p1_info_ptr Used for retrieving the diag mem RAM_size.
...
err_code_t osprey7_v2l8p1_INTERNAL_poll_diag_data(srds_access_t *sa__, const srds_info_t *osprey7_v2l8p1_info_ptr, uint16_t *status, uint8_t *diag_rd_ptr, uint8_t byte_count, uint32_t timeout_ms);
