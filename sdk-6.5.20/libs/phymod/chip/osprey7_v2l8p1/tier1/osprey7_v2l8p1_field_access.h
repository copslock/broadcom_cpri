...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  osprey7_v2l8p1_field_access.h                                        *
...
#ifndef OSPREY7_V2L8P1_API_FIELD_ACCESS_H
#define OSPREY7_V2L8P1_API_FIELD_ACCESS_H
...
/*! @file
 *  @brief Register and field access
 */
...
/*! @defgroup SerdesAPIFieldAccessTag Field Access APIs
 * Serdes API functions for reading and writing to register fields.
 * Also contains Serdes access wrapper dependency functions, which are used
 * for trapping errors from dependency functions.
 */

/*! @addtogroup SerdesAPIFieldAccessTag
 * @{
 */
...
/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for osprey7_v2l8p1_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p1_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p1_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p1_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p1_acc_wr_pram(srds_access_t *sa__, uint8_t val);
...
#define osprey7_v2l8p1_acc_get_physical_lane osprey7_v2l8p1_acc_get_lane
...
#define osprey7_v2l8p1_acc_set_physical_lane osprey7_v2l8p1_acc_set_lane
...
/** Returns address of osprey7_v2l8p1 info table stored in upper level software.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the osprey7_v2l8p1 info table.
 */
srds_info_t *osprey7_v2l8p1_acc_get_info_table_address(srds_access_t *sa__);
#endif

/*! @} SerdesAPIFieldAccessTag */
/*! @} APITag */
