...
/*********************************************************************************
 *********************************************************************************
 *  File Name  :  osprey7_v2l8p1_functions.h
...
#ifndef OSPREY7_V2L8P1_API_FUNCTIONS_H
#define OSPREY7_V2L8P1_API_FUNCTIONS_H
    ...
    do  { \
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return osprey7_v2l8p1_error_report(sa__, *(__ERR)); \
        }\
        (void)srds_err_code; \
    }   while(0)
