...
/**************************************************************************************
 *  File Name     :  osprey7_v2l8p1_usr_includes.h                                        *
...
#ifndef OSPREY7_V2L8P1_API_USR_INCLUDES_H
#define OSPREY7_V2L8P1_API_USR_INCLUDES_H
...
#endif
#define USR_DELAY_MS(stuff) osprey7_v2l8p1_acc_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) osprey7_v2l8p1_acc_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) osprey7_v2l8p1_acc_delay_ns(sa__,stuff)
