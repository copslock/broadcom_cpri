...
#ifndef OSPREY7_V2L8P1_API_DEPENDENCIES_H
#define OSPREY7_V2L8P1_API_DEPENDENCIES_H
 ...
 */
err_code_t osprey7_v2l8p1_pmd_rdt_reg(srds_access_t *sa__, uint16_t address, uint16_t *val);
 ...
 * If using Serdes MDIO controller to access the registers, implement this function using osprey7_v2l8p1_pmd_mdio_mwr_reg(..).
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function.
 *
 *    osprey7_v2l8p1_pmd_wr_reg(addr, ((osprey7_v2l8p1_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
#define osprey7_v2l8p1_get_physical_lane osprey7_v2l8p1_get_lane
...
#define osprey7_v2l8p1_set_physical_lane osprey7_v2l8p1_set_lane
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Pointer to the osprey7_v2l8p1 info table.
 */
