...
#ifndef OSPREY7_V2L8P1_API_PRBS_H
#define OSPREY7_V2L8P1_API_PRBS_H
 ...
 * NOTE: osprey7_v2l8p1_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane. \n\n
 * 
 ...
 * @b Example
 * @code
    EFUN(osprey7_v2l8p1_config_shared_tx_pattern(sa__, 4, "0101"));
    EFUN(osprey7_v2l8p1_tx_shared_patt_gen(en(sa__, 1, 4));
 * @endcode
 ...
 * Note: The patt_length_bits input to the function should be the value sent to the osprey7_v2l8p1_config_shared_tx_pattern() function
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param[in] patt_length_bits length of the pattern in bits used in osprey7_v2l8p1_config_shared_tx_pattern()
 ...
 * Once the PRBS generator is configured, to enable PRBS use the osprey7_v2l8p1_tx_prbs_en() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Once the PRBS checker is configured, use the osprey7_v2l8p1_rx_prbs_en() API to enable the checker.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
struct osprey7_v2l8p1_prbs_chk_hw_timer_ctrl_st {
 ...
 *       To get the BER data, user needs to call osprey7_v2l8p1_get_BER_data_HW_mode() for ber result.
 *       The time between this function call and call to the osprey7_v2l8p1_get_BER_data_HW_mode() can be time_ms long.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: This function call may take up to time_ms delay to complete after calling the osprey7_v2l8p1_config_BER_HW_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/* extern const char* osprey7_v2l8p1_e2s_prbs_mode_enum[22]; */

/*---------------------------------*/
/*  PRBS Error Analyzer Functions  */
/*---------------------------------*/

#define OSPREY7_V2L8P1_PRBS_FEC_FRAME_SIZE_MULTIPLIER         320
#define OSPREY7_V2L8P1_PRBS_FEC_FRAME_SIZE_ROUND_UP           240  /* 3/4th of difference b/w configurable fec_size's (320) */
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_FEC_SIZE_MIN         ( 6 * OSPREY7_V2L8P1_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_FEC_SIZE_MAX         (63 * OSPREY7_V2L8P1_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_ERR_THRESH_MIN        1
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_ERR_THRESH_MAX       15
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MIN   1
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MAX   8
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_FRAME_OVERLAP_FACTOR  8
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_LINEARITY_ADJUST      1.0
#define OSPREY7_V2L8P1_PRBS_ERR_ANALYZER_NUM_COUNTERS          8

#define OSPREY7_V2L8P1_PRBS_FEC_SIZE_FRAC_1_1                  0
#define OSPREY7_V2L8P1_PRBS_FEC_SIZE_FRAC_1_8                  1
#define OSPREY7_V2L8P1_PRBS_FEC_SIZE_FRAC_1_4                  2
#define OSPREY7_V2L8P1_PRBS_FEC_SIZE_FRAC_1_2                  3
#define OSPREY7_V2L8P1_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS    16

/** PRBS Error Analyzer Aggregate Mode */
enum srds_prbs_error_analyzer_aggregate_mode_enum {
    SRDS_OSP_100GE,              /* 100G w/ Bit Muxing 4:1 and no Code Word Interleaving 100GE 112G Osprey */
    SRDS_OSP_200GE,              /* 200G w/ Bit Muxing 4:1 and 2 Code Word Interleaving 200GE/400GE 112G Osprey (D1.5 version) */
    SRDS_CUSTOM
};
...
typedef struct {
  ...
  uint8_t diag_mode;
  /** prbs_errcnt[i] - Num of FEC frames with >i errors (i = 0 to OSPREY7_V2L8P1_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS-1) */ 
  uint32_t prbs_errcnt[OSPREY7_V2L8P1_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS];
...
} osprey7_v2l8p1_prbs_err_analyzer_config_status_st;
...
typedef struct {
  ...
  uint8_t delta_n;
} osprey7_v2l8p1_prbs_err_analyzer_report_st;
