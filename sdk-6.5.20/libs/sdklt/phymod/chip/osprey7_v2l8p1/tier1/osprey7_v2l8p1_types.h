...
#ifndef OSPREY7_V2L8P1_API_TYPES_H
#define OSPREY7_V2L8P1_API_TYPES_H
 ...
 */
typedef struct osprey7_v2l8p1_triage_info_st {
   uint32_t     api_ver;
   uint32_t     ucode_ver;
   uint8_t      core;
   uint8_t      lane;
...
#define SIZE_OF_DBGFB_STATS_STRUCT 488  /* Change the size if osprey7_v2l8p1_dbgfb_stats_st size changes */
/*! Used for maintaining correctness of SIZE_OF_DBGFB_STATS_STRUCT
 */
typedef struct { 
    uint8_t dbgfb_tmp[sizeof(osprey7_v2l8p1_dbgfb_stats_st)==SIZE_OF_DBGFB_STATS_STRUCT ? 1: -1]; 
} osprey7_v2l8p1_dbgfb_stats_st_size_check;
#endif

/*! Used for debug feedback APIs
 */
typedef struct osprey7_v2l8p1_dbgfb_cfg_s {
    uint8_t y;
    uint8_t x;
    uint32_t time_in_us;
    int32_t data1;
 ...
 */
struct osprey7_v2l8p1_uc_lane_config_field_st {
 ...
 */
struct osprey7_v2l8p1_uc_core_config_field_st {
  uint8_t  vco_rate          ;
...
/*! Lane Config Struct
 */
struct  osprey7_v2l8p1_uc_lane_config_st {
  struct osprey7_v2l8p1_uc_lane_config_field_st field;
  uint16_t word;
};
...
/*! Core Config Struct
 */
struct  osprey7_v2l8p1_uc_core_config_st {
  struct osprey7_v2l8p1_uc_core_config_field_st field;
  uint16_t word;
 ...
 */
struct osprey7_v2l8p1_usr_ctrl_func_st {
 ...
 */
struct osprey7_v2l8p1_usr_ctrl_dfe_func_st {
 ...
 */
struct osprey7_v2l8p1_usr_ctrl_disable_functions_st {
  struct osprey7_v2l8p1_usr_ctrl_func_st field;
  uint16_t word;
};

/*! Lane User Control Disable DFE Function Struct
 */
struct osprey7_v2l8p1_usr_ctrl_disable_dfe_functions_st {
  struct osprey7_v2l8p1_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
/*! Used in BER APIs
 */
struct osprey7_v2l8p1_ber_data_st {
    uint64_t num_errs;
    uint64_t num_bits;
    uint8_t lcklost;
    uint8_t prbs_chk_en;
 ...
 */
struct osprey7_v2l8p1_check_platform_info_st {
    char c;
    uint32_t d;
};
...
struct osprey7_v2l8p1_detailed_lane_status_st {
    ...
    int8_t  lms_cal_err;
    int8_t  lms_cal_err_q;
    /** phase calibration residual error */
    int8_t  phase_cal_err;
    int8_t  phase_cal_err_q;
    /** data calibration residual error */
    int8_t data_cal_err;
...
/* Change the size if osprey7_v2l8p1_detailed_lane_status_st size changes */
#define SIZE_OF_EXTENDED_LANE_STATE 1116 + 0

#if !defined(EXCLUDE_FOR_SWIG)
/*! Used for maintaining correctness of SIZE_OF_EXTENDED_LANE_STATE
 */
typedef struct { 
    uint8_t extended_lane_st_tmp[sizeof(struct osprey7_v2l8p1_detailed_lane_status_st)==SIZE_OF_EXTENDED_LANE_STATE ? 1: -1]; 
} osprey7_v2l8p1_detailed_lane_status_st_size_check;
