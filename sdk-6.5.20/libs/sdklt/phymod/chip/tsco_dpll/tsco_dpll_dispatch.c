...
__phymod__dispatch__t__ phymod_tsco_dpll_driver = {

    tsco_dpll_core_identify,
    tsco_dpll_core_info_get,
    tsco_dpll_core_lane_map_set,
    tsco_dpll_core_lane_map_get,
    ...
    tsco_dpll_phy_firmware_lane_config_set,
    tsco_dpll_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    tsco_dpll_phy_polarity_set,
    tsco_dpll_phy_polarity_get,
    tsco_dpll_phy_tx_set,
    tsco_dpll_phy_tx_get,
    ...
    tsco_dpll_phy_tx_lane_control_set,
    tsco_dpll_phy_tx_lane_control_get,
    tsco_dpll_phy_rx_lane_control_set,
    tsco_dpll_phy_rx_lane_control_get,
    ...
    tsco_dpll_timesync_enable_set,
    tsco_dpll_timesync_enable_get,
    ...
    tsco_dpll_timesync_offset_set,
    tsco_dpll_timesync_adjust_set,
    ...
    tsco_dpll_port_enable_set,
    tsco_dpll_port_enable_get,
    ...
    tsco_dpll_phy_speed_config_set,
    tsco_dpll_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tsco_dpll_phy_tx_taps_default_get,
    tsco_dpll_phy_lane_config_default_get,
    tsco_dpll_phy_firmware_load_info_get,
    tsco_dpll_phy_autoneg_advert_ability_set,
    tsco_dpll_phy_autoneg_advert_ability_get,
    tsco_dpll_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tsco_dpll_phy_tx_pam4_precoder_enable_set,
    tsco_dpll_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_set */
    tsco_dpll_phy_pll_reconfig,
    osprey7_v2l8p1_phy_pll_pwrdn,
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tsco_dpll_phy_synce_clk_ctrl_set,
    tsco_dpll_phy_synce_clk_ctrl_get,
    tsco_dpll_phy_pcs_enable_set,
    osprey7_v2l8p1_phy_rx_ppm_get,
    NULL, /* phymod_phy_channel_loss_hint_set */
    NULL, /* phymod_phy_channel_loss_hint_get */
    tsco_dpll_intr_handler,
    tsco_dpll_timesync_tx_info_get,
    NULL, /* phymod_phy_master_set */
    NULL, /* phymod_phy_master_get */
    tsco_dpll_phy_pcs_lane_swap_adjust,
    tsco_dpll_phy_load_speed_id_entry,
    tsco_dpll_phy_pmd_override_enable_set,
    ...
    tsco_dpll_phy_fec_bypass_indication_set,
    tsco_dpll_phy_fec_bypass_indication_get,
    NULL, /* phymod_phy_fec_corruption_period_set */
    NULL, /* phymod_phy_fec_corruption_period_get */
    tsco_dpll_phy_codec_mode_set,
    tsco_dpll_phy_codec_mode_get,
    tsco_dpll_phy_autoneg_speed_id_table_reload,
    tsco_dpll_phy_rs_fec_rxp_get,
