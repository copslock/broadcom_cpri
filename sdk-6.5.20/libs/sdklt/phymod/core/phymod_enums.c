...
enum_mapping_t phymod_dispatch_type_t_mapping[] = {
    ...
    {"Tsco", phymodDispatchTypeTsco},
#endif /*PHYMOD_TSCO_SUPPORT  */
#ifdef PHYMOD_OSPREY7_V2L8P1_SUPPORT
    {"Osprey7_v2l8p1", phymodDispatchTypeOsprey7_v2l8p1},
    ...
    {"Tsco_dpll", phymodDispatchTypeTsco_dpll},
...
enum_mapping_t phymod_core_version_t_mapping[] = {
    ...
    {"Tsco", phymodCoreVersionTsco},
    {"Osprey7_v2l8p1", phymodCoreVersionOsprey7_v2l8p1},
    {"Blackhawk7_l8p2", phymodCoreVersionBlackhawk7_l8p2},
    {"Tsco_dpll", phymodCoreVersionTsco_dpll},
    {NULL, 0}
};
